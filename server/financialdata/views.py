...
class FinancialDataView(TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            company_valuation['quick_ratio_fmt'] = "Data Not Found"
            company_valuation['quick_ratio_raw'] = "Data Not Found"
        try:
            ...
            company_valuation['current_ratio_fmt'] = "Data Not Found"
            company_valuation['current_ratio_raw'] = "Data Not Found"
        ...
        try:
            ...
            company_valuation['ROE_fmt'] = "Data Not Found"
            company_valuation['ROE_raw'] = "Data Not Found"

        if(company_valuation['MarketCap_Raw'] == 'Data Not Found'): company_valuation['marketCapRisk'] = "Market Cap Not Found"
        elif(company_valuation['MarketCap_Raw'] < 250000000): company_valuation['marketCapRisk'] = "Very High"
        ...
        if(company_valuation['P/E_Company'] == 'Data Not Found' or company_valuation['P/E_Sector'] == 'Data Not Found'): company_valuation['P/E_Risk'] = 'Data Not Found'
        elif(company_valuation['P/E_Company'] > company_valuation['P/E_Sector']*2): company_valuation['P/E_Risk'] = 'High'
        ...
        if(company_valuation['P/CF_Company'] == 'Data Not Found' or company_valuation['P/CF_Sector'] == "Data Not Found"): company_valuation['P/CF_Risk'] = 'Data Not Found'
        elif(company_valuation['P/CF_Company'] > company_valuation['P/CF_Sector']*2): company_valuation['P/CF_Risk'] = 'High'
        ...
        if(company_valuation['P/B_Company'] == 'Data Not Found' or company_valuation['P/B_Sector'] == "Data Not Found"): company_valuation['P/B_Risk'] = 'Data Not Found'
        elif(company_valuation['P/B_Company'] > company_valuation['P/B_Sector']*2): company_valuation['P/B_Risk'] = 'High'
        ...
        if(company_valuation['PEG'] == 'Data Not Found'): company_valuation['PEG_Risk'] = 'Data Not Found'
        elif(company_valuation['PEG'] > 2): company_valuation['PEG_Risk'] = 'High'
        ...
        if(company_valuation['quick_ratio_raw'] == "Data Not Found"): company_valuation['quick_ratio_Risk'] = 'Data Not Found'
        elif(company_valuation['quick_ratio_raw'] < 0.5): company_valuation['quick_ratio_Risk'] = 'High'
        ...
        if(company_valuation['current_ratio_raw'] == 'Data Not Found'): company_valuation['current_ratio_Risk'] = 'Data Not Found'
        elif(company_valuation['current_ratio_raw'] < 0.5): company_valuation['current_ratio_Risk'] = 'High'
        ...
        if(company_valuation['ROE_raw'] == 'Data Not Found'): company_valuation['ROE_Risk'] = 'Data Not Found'
        elif(company_valuation['ROE_raw'] < 0): company_valuation['ROE_Risk'] = 'High'
